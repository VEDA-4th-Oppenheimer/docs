...
| [가감속 램프](../../components/stm32/motor-ramp.md) | 사다리꼴 속도 프로파일 — 램프 산수(32비트 정수), 타이머 시간축, ISR 삽입점 |
...
- 가감속 램프는 최초 설계(`647f4ff`, 2026-08-12)가 제 작업이고, 이후 S-Curve 저크 제한
  프로파일로 교체되면서 담당이 넘어갔습니다. 문서는 **사다리꼴 기준** 그대로입니다.
